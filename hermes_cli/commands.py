...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("cwd", "Show or set the default working directory for this chat", "Session",
               gateway_only=True, args_hint="[clear|status|set <absolute-path>|<absolute-path>]"),
